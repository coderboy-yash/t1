...
import img from "../../assets/images/qn3.svg";
...
const Questions = () => {
  ...
  const handleAnswerClick = (answer) => {
    ...
    localStorage.setItem("question9Answer", answer);
    ...
    <div className="flex justify-center items-center overflow-hidden h-[100vh] bg-bgtest bg-cover bg-center font-poppins">
      ...
      <img src={theDots} className="absolute top-3 left-3" />
        <div className="text-[32px] text-white   mt-[71px]  text-left">
          9. How often do you feel overly active and compelled to do things,
          like you can't sit still, or like you need to move around or do
          something even when you don't want to?
        </div>
